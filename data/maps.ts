...
export const maps: MapData[] = [
  ...
  {
    id: "lether-rg",
    name: "Letherii Empire - Reaper's Gale",
    book: "RG",
    bounds: [
      [0, 0],
      [1000, 1000],
    ],
    imageUrl: "/maps/lether-rg.jpg",
    locations: [
      // Major Cities
      {
        name: "Letheras",
        coordinates: [520, 650],
        description:
          "Capital of the Letherii Empire. Site of the final confrontation between Rhulad and Karsa, Tehol's economic revolution, and the Bonehunters' siege. The eternal city falls.",
        type: "city",
      },
      {
        name: "Drene",
        coordinates: [420, 450],
        description: "City where the Awl rebellion begins. Redmask gathers his forces here.",
        type: "city",
      },
      {
        name: "Brous",
        coordinates: [380, 520],
        description: "Letherii city along the Bonehunters' march.",
        type: "city",
      },
      // Battlefields
      {
        name: "Awl'dan Plains",
        coordinates: [450, 400],
        description: "The vast plains where Redmask leads the Awl to their doom. The Letherii legions slaughter them.",
        type: "battlefield",
      },
      {
        name: "Siege of Letheras",
        coordinates: [515, 655],
        description: "The Bonehunters' assault on the capital. Beak's sacrifice saves them from Leoman's firestorm.",
        type: "battlefield",
      },
      {
        name: "The Throne Room",
        coordinates: [522, 652],
        description: "Where Karsa Orlong faces Rhulad. The sword is destroyed, the Emperor finally freed.",
        type: "landmark",
      },
      // Landmarks
      {
        name: "Old Palace",
        coordinates: [518, 648],
        description: "Tehol's base of operations. Where the economic revolution was planned.",
        type: "landmark",
      },
      {
        name: "Patriotists' Headquarters",
        coordinates: [525, 647],
        description: "Karos Invictad's torture chambers. Site of Janath's imprisonment.",
        type: "landmark",
      },
      {
        name: "The Refugium",
        coordinates: [300, 200],
        description: "Hidden sanctuary of the living Imass. Where Kilava guards those who refused the Ritual.",
        type: "landmark",
      },
      {
        name: "Settle Lake",
        coordinates: [600, 450],
        description: "Lake where critical events unfold in the approach to Letheras.",
        type: "landmark",
      },
      {
        name: "High Fort",
        coordinates: [470, 380],
        description: "Letherii military fortress near the Awl territories.",
        type: "fortress",
      },
    ],
    journeys: [
      // THE BONEHUNTERS - March to Letheras
      {
        group: "The Bonehunters",
        path: [
          [200, 800], // Landing from sea
          [250, 750], // Initial march inland
          [300, 700], // Through Letherii territory
          [350, 640], // Approaching interior
          [380, 600], // Near Brous
          [420, 580], // Past Brous
          [460, 620], // Final approach
          [490, 640], // Outside Letheras
          [505, 650], // Beak's sacrifice point
          [520, 650], // Letheras - siege
        ],
        color: "#d4af37",
        description:
          "Tavore, Fiddler, Quick Ben, Kalam, Gesler, and the Bonehunters march across Lether to besiege the capital.",
        summary:
          "The Bonehunters land on Lether's coast and march inland, a battered army seeking to fulfill their Adjunct's mysterious mission. The march is grueling - they face Letherii opposition, supply problems, and the sheer exhaustion of being so far from home.\n\nAs they approach Letheras, Leoman of the Flails (now serving Rhulad) prepares a massive firestorm trap. Just when it seems the army will be annihilated, Beak - the simple-minded mage who sees warrens as colors - steps forward. He opens all twelve warrens simultaneously, creating overlapping shields of protection. The strain kills him, but he holds the shields until every Bonehunter is safe. 'The colors were so pretty,' he thinks as he dies.\n\nThe Bonehunters take Letheras. Tavore finally achieves... something. But the cost has been immense, and her soldiers still don't know why they're here.",
      },
      // KARSA & COMPANIONS - Fleet arrivals
      {
        group: "Karsa & Fleet Arrivals",
        path: [
          [180, 750], // Arriving by sea
          [220, 700], // Coastal landing
          [280, 650], // Moving inland
          [350, 620], // Traveling to capital
          [420, 640], // Approaching
          [480, 650], // Outside city
          [520, 650], // Letheras - confrontation
        ],
        color: "#8b4513",
        description: "Karsa Orlong, Samar Dev, Icarium, and Taralack Veed arrive seeking the Emperor.",
        summary:
          "Karsa Orlong arrives in Lether with simple purpose: challenge Rhulad Sengar, the Emperor of a Thousand Deaths. The Toblakai warrior has heard of this 'unkillable' emperor and wants to test himself.\n\nSamar Dev, the witch who has become Karsa's companion (much to her own surprise), accompanies him. Also arriving: Icarium the Jhag and his new 'guardian' Taralack Veed, who plans to unleash Icarium's destructive rage.\n\nThe convergence at Letheras brings all these forces together. Karsa faces Rhulad in single combat. Instead of trying to kill the Emperor, Karsa simply... destroys the cursed sword. The blade that has killed and resurrected Rhulad thousands of times shatters. Rhulad, free at last, thanks Karsa and dies permanently. A thousand deaths finally end.",
      },
      // THE AWL REBELLION
      {
        group: "The Awl Rebellion",
        path: [
          [420, 450], // Drene - gathering point
          [440, 420], // Moving to plains
          [450, 400], // Main battlefield
          [460, 380], // Retreat
          [470, 360], // Collapse
        ],
        color: "#dc143c",
        description: "Redmask, Torrent, Toc Anaster, and the Awl clans rebel against Lether.",
        summary:
          "Redmask, a mysterious figure wearing a red-painted mask, returns to unite the Awl clans against Letherii oppression. The Awl are plains nomads, proud horse warriors who have suffered under Letherii expansion and economic exploitation.\n\nTorrent, a young Awl warrior, believes in Redmask at first. Toc Anaster (Toc the Younger reborn) rides with them, bound by the Wolf Gods' service. The Awl ride to war on the vast plains.\n\nBut Redmask is broken, driven by vengeance rather than wisdom. He leads the Awl into battles they cannot win. The Letherii legions are too disciplined, too numerous. The K'Chain Che'Malle war machines Redmask hoped to control turn on their own people. The Awl are slaughtered. Thousands die. Redmask's rebellion becomes a genocide. The Awl'dan plains run red with blood, and a people are nearly destroyed.",
      },
      // FEAR SENGAR'S QUEST
      {
        group: "Fear Sengar's Quest",
        path: [
          [520, 650], // Letheras - start
          [480, 600], // Leaving the city
          [420, 550], // Into wilderness
          [380, 480], // Seeking answers
          [340, 420], // Deeper into past
          [300, 200], // The Refugium
        ],
        color: "#4b0082",
        description: "Fear Sengar, Seren Pedac, Udinaas, Silchas Ruin, and Kettle seek to free Scabandari's spirit.",
        summary:
          "Fear Sengar, eldest of the Sengar brothers, seeks to free his people from the Crippled God's chains by liberating their god Scabandari Bloodeye's trapped spirit. He travels with Seren Pedac (former Acquitor), Udinaas (former slave with a Wyval's power), the terrifying Silchas Ruin (white-skinned Tiste Andii Soletaken), and Kettle (undead guardian child).\n\nTheir quest takes them into the deep past, to places where the Tiste Edur's history lies buried. They encounter the Refugium, where living Imass dwell under Kilava's protection - the Imass who refused the Ritual of Tellan 300,000 years ago.\n\nFear's quest ends in tragedy. He learns terrible truths about Scabandari's betrayal of Silchas Ruin. The past cannot be undone. Some spirits are better left trapped. Fear dies not having saved his people, but perhaps understanding them better.",
      },
      // TEHOL'S REVOLUTION
      {
        group: "Tehol's Economic Revolution",
        path: [
          [518, 648], // Old Palace - base
          [520, 650], // Letheras streets
          [522, 647], // Through districts
          [520, 652], // To the Eternal Domicile
        ],
        color: "#ffd700",
        description: "Tehol Beddict, Bugg (Mael), and their allies dismantle the Letherii economic system from within.",
        summary:
          "Tehol Beddict, genius and former economic savant, lives in rags on a rooftop with his manservant Bugg (secretly Mael, Elder God of the Seas). Together they orchestrate the most audacious plan in Letherii history: the complete collapse of the economic system that enslaves the poor through debt.\n\nTehol has spent years placing agents, creating shell companies, and manipulating markets. His allies include Rucket (resistance leader), Shurq Elalle (undead pirate captain), and Ublala Pung (Tarthenal bodyguard). When the moment comes, Tehol pulls every string simultaneously.\n\nThe result: economic collapse. The indebted are suddenly free. The merchants are ruined. The entire system of exploitation crumbles. In the chaos following the Bonehunters' siege and Rhulad's death, Tehol emerges as the obvious choice for king. The beggar becomes royalty. Bugg becomes his Ceda. Janath Anar, tortured academic rescued from Karos Invictad, becomes his queen. A new Lether is born.",
      },
    ],
  },
  {
